    ...
    <>
      ...
      >
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded bg-[#fd761a] flex items-center justify-center">
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 rounded-md text-white bg-white/10 border-none cursor-pointer"
        >
          <Menu size={20} />
        </button>
      </header>
      ...
      {/* Drawer */}
      <div
        className={`lg:hidden fixed top-0 left-0 bottom-0 z-60 w-[280px] flex flex-col transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 min-h-[64px] border-b border-white/10">
          ...
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-md text-white/70 bg-white/10 hover:text-white transition-colors cursor-pointer"
          >
            <X size={18} />
          </button>
        </div>
          ...
          {visibleItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon
                  size={18}
                  className={isActive ? "text-[#fd761a]" : "text-inherit"}
                />
                {item.label}
              </Link>
            );
